...
import '../../absence/views/absence_page.dart';
import '../../change_request/views/change_request_page.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "123 Maple Street",
                        style: TextStyle(
                          color: Color.fromARGB(255, 97, 117, 138),
                          fontSize: 16,
                        ),
                      ),
                    ],
                      ...
                      IconBox(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(builder: (_) => PinCodePage()),
                          );
                        },
                      ),
                      Text(
                  ...
                  Column(
                    ...
                    children: [
                      IconBox(
                        ...
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(builder: (_) => AbsencePage()),
                          );
                        },
                      ),
                      Text(
